...
import { Calendar, Clock, User, Mail, Phone, MessageSquare, Stethoscope, Video, Home, Sparkles, CheckCircle2 } from 'lucide-react';
...
const BookingAppointment = () => {
  ...
  const appointmentTypes = [
    { value: 'video', label: 'Video Consultation', icon: <Video className="w-5 h-5" /> },
    { value: 'home', label: 'Home Visit', icon: <Home className="w-5 h-5" /> },
    { value: 'clinic', label: 'In-Clinic', icon: <Stethoscope className="w-5 h-5" /> }
  ];
      ...
      <div className="relative max-w-6xl mx-auto px-6 py-24">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-slate-300 text-lg max-w-2xl mx-auto leading-relaxed">
            Schedule a consultation with our expert healthcare professionals at your convenience.
          </p>
        </div>
        ...
        <div className="relative group">
          ...
          {/* Form Card */}
          <div className="relative bg-slate-900/50 backdrop-blur-xl border border-slate-700/50 rounded-3xl p-8 md:p-12">
            {!isSubmitted ? (
              <div className="space-y-6">
                    ...
                    {appointmentTypes.map((type) => (
                      <label
                        ...
                        className={`relative cursor-pointer group/radio ${
                          formData.type === type.value ? 'ring-2 ring-cyan-500' : ''
                        }`}
                      >
                        <input
                          type="radio"
                        ...
                        <div className={`flex items-center gap-3 p-4 rounded-xl border transition-all duration-300 ${
                          ...
                          <div className={`${
                            formData.type === type.value ? 'text-cyan-400' : 'text-slate-400'
                          }`}>
                            {type.icon}
                          </div>
                          <span className={`text-sm font-medium ${
                            formData.type === type.value ? 'text-white' : 'text-slate-300'
                          }`}>
                            {type.label}
                          </span>
                        </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      value={formData.name}
                      onChange={handleChange}
                      className="w-full px-4 py-3 bg-slate-800/50 border border-slate-700/50 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-cyan-500/50 focus:border-cyan-500/50 transition-all duration-300"
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className="w-full px-4 py-3 bg-slate-800/50 border border-slate-700/50 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-pink-500/50 focus:border-pink-500/50 transition-all duration-300"
                  ...
                  <div>
                    ...
                    <input
                      ...
                      value={formData.date}
                      onChange={handleChange}
                      className="w-full px-4 py-3 bg-slate-800/50 border border-slate-700/50 rounded-xl text-white focus:outline-none focus:ring-2 focus:ring-cyan-500/50 focus:border-cyan-500/50 transition-all duration-300"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      value={formData.time}
                      onChange={handleChange}
                      className="w-full px-4 py-3 bg-slate-800/50 border border-slate-700/50 rounded-xl text-white focus:outline-none focus:ring-2 focus:ring-purple-500/50 focus:border-purple-500/50 transition-all duration-300"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    rows="4"
                    className="w-full px-4 py-3 bg-slate-800/50 border border-slate-700/50 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-pink-500/50 focus:border-pink-500/50 transition-all duration-300 resize-none"
              ...
              <div className="text-center py-12">
                ...
                <p className="text-slate-400">
                  A confirmation email will be sent to <span className="text-cyan-400">{formData.email}</span>
                </p>
              </div>
            )}
          </div>
