...
const BRANCHES = [
  { id: 1, location: "Gulshan Branch",    doctors: 18, patients: 1240, appointments_today: 47 },
  { id: 2, location: "Dhanmondi Branch",  doctors: 14, patients:  980, appointments_today: 38 },
  { id: 3, location: "Mirpur Branch",     doctors: 11, patients:  730, appointments_today: 29 },
  { id: 4, location: "Uttara Branch",     doctors:  9, patients:  510, appointments_today: 21 },
  { id: 5, location: "Chattogram Branch", doctors: 12, patients:  640, appointments_today: 25 },
];
...
const DOCTORS = [
  { id: 1,  name: "Dr. Arif Hossain",    specialty: "Cardiology",    branch: "Gulshan Branch",    dept: "Cardiology",  fee: 1200, joining: "2020-03-01", rating: 4.8, status: "Active"   },
  { id: 2,  name: "Dr. Meera Sultana",   specialty: "Dermatologist", branch: "Dhanmondi Branch",  dept: "Dermatology", fee:  900, joining: "2021-06-15", rating: 4.6, status: "Active"   },
  { id: 3,  name: "Dr. Tanvir Ahmed",    specialty: "Neurologist",   branch: "Gulshan Branch",    dept: "Neurology",   fee: 1100, joining: "2019-11-01", rating: 4.7, status: "Active"   },
  { id: 4,  name: "Dr. Rupa Chowdhury", specialty: "Orthopedist",   branch: "Mirpur Branch",     dept: "Orthopedics", fee: 1000, joining: "2022-01-10", rating: 4.5, status: "Active"   },
  { id: 5,  name: "Dr. Sajid Islam",     specialty: "Ophthalmology", branch: "Uttara Branch",     dept: "Ophthalmology",fee: 800, joining: "2021-08-20", rating: 4.4, status: "Active"   },
  { id: 6,  name: "Dr. Lailun Nahar",    specialty: "Pediatrician",  branch: "Chattogram Branch", dept: "Pediatrics",  fee:  850, joining: "2020-05-12", rating: 4.9, status: "Active"   },
  { id: 7,  name: "Dr. Kamrul Hasan",    specialty: "Oncologist",    branch: "Gulshan Branch",    dept: "Oncology",    fee: 1500, joining: "2018-09-01", rating: 4.7, status: "On Leave" },
  { id: 8,  name: "Dr. Shirin Akter",    specialty: "Radiologist",   branch: "Dhanmondi Branch",  dept: "Radiology",   fee:  950, joining: "2023-02-28", rating: 4.3, status: "Active"   },
];

const PATIENTS = [
  { id: 101, name: "Nadia Rahman",    age: 28, gender: "Female", mobile: "01712-345678", city: "Dhaka",      joined: "2024-01-15", visits: 4,  branch: "Gulshan Branch"   },
  { id: 102, name: "Karim Uddin",     age: 45, gender: "Male",   mobile: "01611-998877", city: "Chattogram", joined: "2024-02-20", visits: 2,  branch: "Dhanmondi Branch" },
  { id: 103, name: "Sumaiya Akter",   age: 33, gender: "Female", mobile: "01911-445566", city: "Dhaka",      joined: "2024-03-05", visits: 1,  branch: "Gulshan Branch"   },
  { id: 104, name: "Rafiq Hasan",     age: 60, gender: "Male",   mobile: "01511-332211", city: "Sylhet",     joined: "2023-11-10", visits: 6,  branch: "Mirpur Branch"    },
  { id: 105, name: "Tania Begum",     age: 52, gender: "Female", mobile: "01811-667788", city: "Dhaka",      joined: "2023-08-01", visits: 3,  branch: "Uttara Branch"    },
  { id: 106, name: "Jahangir Alam",   age: 38, gender: "Male",   mobile: "01712-001122", city: "Rajshahi",   joined: "2024-04-01", visits: 2,  branch: "Gulshan Branch"   },
  { id: 107, name: "Nasrin Khatun",   age: 41, gender: "Female", mobile: "01611-334455", city: "Dhaka",      joined: "2023-12-18", visits: 5,  branch: "Dhanmondi Branch" },
  { id: 108, name: "Mizanur Rahman",  age: 55, gender: "Male",   mobile: "01911-556677", city: "Khulna",     joined: "2024-01-30", visits: 1,  branch: "Chattogram Branch"},
];

const APPOINTMENTS = [
  { id: 1, patient: "Nadia Rahman",   doctor: "Dr. Arif Hossain",   branch: "Gulshan Branch",    date: "2025-04-02", time: "09:00:00", status: "Confirmed" },
  { id: 2, patient: "Karim Uddin",    doctor: "Dr. Arif Hossain",   branch: "Gulshan Branch",    date: "2025-04-02", time: "09:30:00", status: "Confirmed" },
  { id: 3, patient: "Sumaiya Akter",  doctor: "Dr. Meera Sultana",  branch: "Dhanmondi Branch",  date: "2025-04-02", time: "10:00:00", status: "Pending"   },
  { id: 4, patient: "Rafiq Hasan",    doctor: "Dr. Tanvir Ahmed",   branch: "Gulshan Branch",    date: "2025-04-02", time: "10:30:00", status: "Pending"   },
  { id: 5, patient: "Tania Begum",    doctor: "Dr. Rupa Chowdhury", branch: "Mirpur Branch",     date: "2025-04-01", time: "11:00:00", status: "Completed" },
  { id: 6, patient: "Jahangir Alam",  doctor: "Dr. Sajid Islam",    branch: "Uttara Branch",     date: "2025-04-01", time: "11:30:00", status: "Completed" },
  { id: 7, patient: "Nasrin Khatun",  doctor: "Dr. Lailun Nahar",   branch: "Chattogram Branch", date: "2025-03-30", time: "09:00:00", status: "Completed" },
  { id: 8, patient: "Mizanur Rahman", doctor: "Dr. Kamrul Hasan",   branch: "Gulshan Branch",    date: "2025-03-29", time: "14:00:00", status: "Cancelled" },
];
...
const STATUS_MAP = {
  ...
  Active:    { color: "text-emerald-500", bg: "bg-emerald-50 dark:bg-emerald-900/20", border: "border-emerald-200 dark:border-emerald-800/40",  dot: "bg-emerald-400" },
  "On Leave":{ color: "text-amber-500",   bg: "bg-amber-50   dark:bg-amber-900/20",   border: "border-amber-200   dark:border-amber-800/40",   dot: "bg-amber-400"   },
};
...
function Avatar({ name, size = "md", className = "" }) {
  ...
  return (
    <div className={`${sz} rounded-full bg-gradient-to-br from-violet-500 to-indigo-600 flex items-center justify-center text-white font-bold shrink-0 ${className}`}>
      {initials(name)}
    </div>
  );
}
...
function StatCard({ label, value, Icon, color, bg, trend, sub }) {
  return (
    <Card hover className="p-5">
      ...
      {trend && (
        <div className={`flex items-center gap-1 mt-2 text-xs font-semibold ${trend > 0 ? "text-emerald-500" : "text-rose-500"}`}>
...
function OverviewTab({ setSearchParams }) {
  ...
  const totalRevenue      = APPOINTMENTS.filter(a => a.status === "Completed").length * 1050; // avg fee

  const stats = [
    { label: "Total Doctors",       value: totalDoctors,      Icon: Stethoscope,  color: "text-violet-500",  bg: "bg-violet-500/10",  trend: +8  },
    { label: "Total Patients",      value: totalPatients,     Icon: Users,         color: "text-blue-500",    bg: "bg-blue-500/10",    trend: +14 },
    { label: "Appointments Today",  value: todayAppts,        Icon: CalendarDays,  color: "text-teal-500",    bg: "bg-teal-500/10",    sub: `${totalAppointments} all time` },
    { label: "Active Branches",     value: totalBranches,     Icon: GitBranch,     color: "text-indigo-500",  bg: "bg-indigo-500/10",  sub: "5 cities"    },
    { label: "Departments",         value: DEPARTMENTS.length,Icon: Layers,        color: "text-pink-500",    bg: "bg-pink-500/10",    sub: "8 specialties" },
    { label: "Revenue (Completed)", value: `৳${(totalRevenue/1000).toFixed(1)}k`, Icon: DollarSign, color: "text-emerald-500", bg: "bg-emerald-500/10", trend: +6 },
  ];
  ...
  return (
    <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3 }}>
      ...
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-violet-600 via-indigo-600 to-indigo-700 p-7 mb-7 text-white">
        ...
        <p className="text-xs uppercase tracking-widest text-violet-200 mb-1">Admin Control Panel</p>
        <h2 className="text-2xl font-bold mb-1">Welcome back, {ADMIN.manager_name.split(" ")[0]} 👋</h2>
        <p className="text-sm text-indigo-100 max-w-lg">
          Managing {totalDoctors} doctors across {totalBranches} branches · {todayAppts} appointments scheduled today.
        </p>
        <div className="flex flex-wrap gap-2 mt-4">
          <button onClick={() => goTab("doctors")} className="inline-flex items-center gap-2 bg-white/15 hover:bg-white/25 transition border border-white/25 text-white text-xs font-semibold px-3 py-1.5 rounded-xl">
            <Stethoscope className="w-3.5 h-3.5" /> Manage Doctors
          </button>
          <button onClick={() => goTab("appointments")} className="inline-flex items-center gap-2 bg-white/15 hover:bg-white/25 transition border border-white/25 text-white text-xs font-semibold px-3 py-1.5 rounded-xl">
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        ...
        <Card className="p-5">
          <div className="flex items-center justify-between mb-5">
            <h3 className="text-sm font-bold uppercase tracking-widest text-slate-400 dark:text-slate-500">Branch Activity</h3>
            <button onClick={() => goTab("branches")} className="text-xs text-violet-500 hover:text-violet-600 font-semibold flex items-center gap-1">
            ...
            {BRANCHES.map((b) => (
              <div key={b.id}>
                <div className="flex items-center justify-between mb-1.5">
                  <span className="text-xs font-semibold text-slate-700 dark:text-slate-300">{b.location}</span>
                  <span className="text-xs text-slate-400">{b.appointments_today} appts today</span>
                </div>
                <div className="flex items-center gap-2">
                  <MiniBar value={b.appointments_today} max={maxAppts} color="bg-violet-500" />
                  <span className="text-[10px] text-slate-400 w-8 text-right shrink-0">{b.doctors} dr</span>
                </div>
              </div>
            ))}
          </div>
        ...
        <Card className="p-5">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-sm font-bold uppercase tracking-widest text-slate-400 dark:text-slate-500">Recent Appointments</h3>
            <button onClick={() => goTab("appointments")} className="text-xs text-violet-500 hover:text-violet-600 font-semibold flex items-center gap-1">
              View all <ArrowRight className="w-3 h-3" />
            </button>
          </div>
          <div className="space-y-0">
            {APPOINTMENTS.slice(0, 5).map((a, i) => (
              <div key={a.id} className={`flex items-center gap-3 py-2.5 ${i < 4 ? "border-b border-slate-100 dark:border-slate-800" : ""}`}>
                <EntityAvatar name={a.patient} />
                <div className="flex-1 min-w-0">
                  <p className="text-xs font-semibold text-slate-800 dark:text-slate-200 truncate">{a.patient}</p>
                  <p className="text-[11px] text-slate-400 dark:text-slate-500 truncate">{a.doctor}</p>
                </div>
                <div className="shrink-0 text-right">
                  <StatusBadge status={a.status} />
                  <p className="text-[10px] text-slate-400 mt-1">{fmtDate(a.date)}</p>
                </div>
              </div>
            ))}
          </div>
...
function DoctorsTab() {
  ...
  return (
    <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3 }}>
      ...
      <SearchBar value={query} onChange={setQuery} placeholder="Search by name or specialty…" />

      {/* Filters */}
      <div className="flex flex-wrap gap-2 mb-6">
        <div className="flex flex-wrap gap-1.5">
          <span className="text-[11px] text-slate-400 self-center mr-1">Branch:</span>
          {branches.slice(0, 4).map(b => (
            <button key={b} onClick={() => setBranch(b)} className={`text-xs font-semibold px-3 py-1 rounded-full border transition ${
              branch === b ? "bg-violet-600 text-white border-transparent" : "bg-white dark:bg-slate-900 text-slate-500 border-slate-200 dark:border-slate-700 hover:border-slate-400"
            }`}>{b === "All" ? "All" : b.replace(" Branch", "")}</button>
          ))}
        </div>
      </div>
      ...
      <div className="flex flex-col gap-3">
        <AnimatePresence mode="popLayout">
          {filtered.map((d, i) => (
            <motion.div key={d.id} layout initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, scale: 0.97 }} transition={{ delay: i * 0.03 }}>
              <Card hover className="p-4 sm:p-5">
                <div className="flex flex-wrap items-center gap-4">
                  <EntityAvatar name={d.name} />
                  <div className="flex-1 min-w-[140px]">
                    <p className="font-bold text-slate-900 dark:text-white text-sm">{d.name}</p>
                    <p className="text-xs text-slate-400 dark:text-slate-500 mt-0.5">{d.specialty} · {d.branch}</p>
                  </div>

                  {/* Fee + rating */}
                  <div className="hidden sm:flex flex-col items-end gap-1 min-w-[90px]">
                    <span className="text-xs font-bold text-slate-700 dark:text-slate-300">৳{d.fee} / visit</span>
                ...
                <div className="sm:hidden flex flex-wrap gap-3 mt-3 pt-3 border-t border-slate-100 dark:border-slate-800 text-[11px] text-slate-400">
                  ...
                  <span className="flex items-center gap-0.5"><Star className="w-3 h-3 fill-amber-400 text-amber-400" />{d.rating}</span>
        ...
        {filtered.length === 0 && (
          <div className="text-center py-16 text-slate-400 text-sm">No doctors match your filters</div>
        )}
      </div>
    </motion.div>
  );
  ...
  return (
    <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3 }}>
      <SectionHeading action={
        <p className="text-sm text-slate-400 dark:text-slate-500 font-normal">{PATIENTS.length} registered</p>
      }>
        Patient Registry
      </SectionHeading>
      ...
      <div className="flex flex-col gap-3">
        <AnimatePresence mode="popLayout">
          {filtered.map((p, i) => (
            <motion.div key={p.id} layout initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, scale: 0.97 }} transition={{ delay: i * 0.03 }}>
              <Card hover className="p-4 sm:p-5">
                <div className="flex flex-wrap items-center gap-4">
                  ...
                  <div className="hidden sm:flex flex-col items-end gap-1 min-w-[110px]">
                    <span className="text-xs font-bold text-slate-600 dark:text-slate-300">{p.branch.replace(" Branch","")}</span>
                    <span className="text-[11px] text-slate-400">{p.visits} visits</span>
                  </div>
                  <span className="text-[11px] text-slate-400 hidden sm:inline">Since {fmtDate(p.joined)}</span>
                  <div className="flex items-center gap-1.5 shrink-0">
                    <button className="w-8 h-8 flex items-center justify-center rounded-xl bg-violet-50 dark:bg-violet-900/20 text-violet-500 hover:bg-violet-100 dark:hover:bg-violet-900/40 transition">
                      <Pencil className="w-3.5 h-3.5" />
                    </button>
        ...
        {filtered.length === 0 && (
          <div className="text-center py-16 text-slate-400 text-sm">No patients match your filters</div>
        )}
      </div>
    </motion.div>
  );
...
function AppointmentsTab() {
  ...
  return (
    <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3 }}>
      ...
      <SearchBar value={query} onChange={setQuery} placeholder="Search patient, doctor, or branch…" />

      <div className="flex flex-wrap gap-2 mb-6">
        {["All", "Confirmed", "Pending", "Completed", "Cancelled"].map(s => (
          <button key={s} onClick={() => setFilter(s)} className={`text-xs font-semibold px-4 py-1.5 rounded-full border transition ${
            filter === s ? "bg-slate-900 dark:bg-white text-white dark:text-slate-900 border-transparent" : "bg-white dark:bg-slate-900 text-slate-500 dark:text-slate-400 border-slate-200 dark:border-slate-700 hover:border-slate-400"
          }`}>{s}</button>
        ))}
      </div>
      ...
      <div className="flex flex-col gap-3">
        <AnimatePresence mode="popLayout">
          {filtered.map((a, i) => (
            <motion.div key={a.id} layout initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, scale: 0.97 }} transition={{ delay: i * 0.03 }}>
              <Card hover className="p-4 sm:p-5">
                <div className="flex flex-wrap items-center gap-4">
                  <EntityAvatar name={a.patient} />
                  <div className="flex-1 min-w-[130px]">
                    <p className="font-bold text-slate-900 dark:text-white text-sm">{a.patient}</p>
                    <p className="text-xs text-slate-400 dark:text-slate-500 mt-0.5">{a.doctor}</p>
                  </div>
                  <div className="hidden sm:flex flex-col gap-1 min-w-[140px]">
                    ...
                    <div className="flex items-center gap-1.5 text-xs text-slate-500 dark:text-slate-400">
                      <MapPin className="w-3.5 h-3.5 text-slate-400" /> {a.branch.replace(" Branch","")}
                    </div>
                  </div>
                  <StatusBadge status={a.status} />
                </div>
            ...
            <Card hover className="p-5">
              <div className="flex items-start justify-between mb-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-bold text-slate-900 dark:text-white text-sm">{b.location}</p>
                    <p className="text-[11px] text-slate-400 mt-0.5">Branch ID #{b.id}</p>
                  </div>
                </div>
              ...
              <div>
                ...
                <MiniBar value={b.patients} max={maxPatients} color="bg-gradient-to-r from-violet-500 to-indigo-500" />
              </div>
            </Card>
          </motion.div>
        ))}
        ...
        {DEPARTMENTS.map((d, i) => (
          <motion.div key={d.id} initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.04 }}>
            <Card hover className="p-4">
              ...
              <p className="font-bold text-slate-800 dark:text-white text-sm mb-1">{d.name}</p>
              <div className="flex items-center gap-3 text-[11px] text-slate-400">
                <span className="flex items-center gap-1"><Stethoscope className="w-3 h-3" />{d.doctors} doctors</span>
                <span className="flex items-center gap-1"><FlaskConical className="w-3 h-3" />{d.labs} labs</span>
              </div>
            </Card>
          </motion.div>
        ))}
    ...
    <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3 }}>
      ...
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-violet-600 via-indigo-600 to-indigo-700 p-7 mb-6 text-white">
        ...
        <div className="flex flex-wrap items-center gap-5">
          <Avatar name={ADMIN.manager_name} size="xl" className="ring-2 ring-white/30" />
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6">
        {[
          { label: "Branches",    value: BRANCHES.length,    color: "text-violet-500", bg: "bg-violet-500/10" },
          { label: "Departments", value: DEPARTMENTS.length, color: "text-indigo-500", bg: "bg-indigo-500/10" },
          { label: "Doctors",     value: DOCTORS.length,     color: "text-blue-500",   bg: "bg-blue-500/10"   },
          { label: "Patients",    value: PATIENTS.length,    color: "text-teal-500",   bg: "bg-teal-500/10"   },
        ].map(s => (
    ...
    <div className="flex flex-col h-full">
      ...
      <Link to="/" className="flex items-center gap-2.5 px-5 py-5 mb-2">
        ...
        <div>
          ...
          <p className="text-[9px] tracking-widest text-slate-400 dark:text-slate-500">ADMIN PORTAL</p>
        </div>
      </Link>
      ...
      <div className="mx-4 mb-5 p-3.5 rounded-2xl bg-gradient-to-br from-violet-500/10 to-indigo-500/10 border border-slate-200 dark:border-slate-700/50 flex items-center gap-3">
        ...
        <div className="min-w-0">
          <p className="text-xs font-bold text-slate-900 dark:text-white truncate">{ADMIN.manager_name}</p>
          <p className="text-[10px] text-slate-400 dark:text-slate-500">Branch Manager</p>
        </div>
      </div>

      {/* Nav — grouped */}
      <nav className="flex-1 px-3 space-y-0.5 overflow-y-auto">
        <p className="text-[10px] uppercase tracking-widest text-slate-400 dark:text-slate-600 px-3 pt-1 pb-2">Main</p>
        ...
        <p className="text-[10px] uppercase tracking-widest text-slate-400 dark:text-slate-600 px-3 pt-4 pb-2">Management</p>
        ...
        <p className="text-[10px] uppercase tracking-widest text-slate-400 dark:text-slate-600 px-3 pt-4 pb-2">Account</p>
      ...
      <div className="px-3 pb-5 pt-4 border-t border-slate-200 dark:border-slate-800 space-y-1 shrink-0">
        ...
        <Link to="/" className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-semibold text-rose-500 hover:bg-rose-50 dark:hover:bg-rose-900/20 transition">
      ...
      <div className="lg:pl-60 flex flex-col min-h-screen">
        ...
        <header className="sticky top-0 z-30 h-16 bg-white/80 dark:bg-slate-950/80 backdrop-blur-xl border-b border-slate-200 dark:border-slate-800 flex items-center gap-4 px-5 sm:px-7">
          ...
          <div className="flex items-center gap-2 text-sm">
            <span className="text-slate-400 dark:text-slate-500 hidden sm:inline">Admin Dashboard</span>
          ...
          {TABS.map(({ id, label, Icon }) => {
            ...
            return (
              <button key={id} onClick={() => setTab(id)}
                ...
                {isActive && <span className="w-1 h-1 rounded-full bg-violet-500" />}
              </button>
            );
          })}
        </nav>
